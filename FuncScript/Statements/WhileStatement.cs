...
public class WhileStatement : Statement, IInitializable
{
    ...
    public override bool OnParse(ref TokenList list)
    {
        ...
        if (condition == null)
        {
            LoggingManager.LogError("Invalid condition in while statement");
            return false;
        }
        ...
        string loopFunctionName = IdManager.GetFunctionId();
